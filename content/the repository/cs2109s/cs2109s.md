...
- **["Classical" AI (Search)](Notes/Searching.md)**
	- [**Uninformed Search**](Notes/Searching/Uninformed%20Search.md):
	    - Breadth-First Search (BFS)
	    - Depth-First Search (DFS)
	    - Depth-Limited Search (DLS)
	    - Iterative Deepening Search (IDS)
	- [**Informed Search**](Notes/Searching/Informed%20Search.md):  
	    - Greedy Best-First Search
	    - A* Search
	    - Heuristic functions and their design
	- **[Local Search](Notes/Searching/Local%20Search.md):**
	    - Hill-Climbing
	    - Simulated Annealing
	    - Evaluation functions for local search strategies
	- **[Adversarial Search](Notes/Searching/Adversarial%20Search.md)**:  
	    - Minimax Algorithm
	    - Alpha-Beta Pruning
	    - Evaluation functions for game scenarios
* **[Classical Machine Learning](Notes/Classical%20Machine%20Learning.md)**
	* **[Supervised Learning](Notes/Classical%20ML/Supervised%20Learning.md)**
		- **[Decision Tree](Notes/Classical%20ML/Supervised%20Learning/Decision%20Tree.md)**
		    - Decision Trees
