---
{"publish":true,"title":"Synchronous and Asynchronous","tags":["CS2030S","java_programming"],"PassFrontmatter":true}
---
...
The `CompletableFuture` class is a [[schoolwork/cs2030s/FP/Monads\|monad]] with the ability to hold a function, and check if the value promised is ready or not (if the task(s) encapsulated are complete).
