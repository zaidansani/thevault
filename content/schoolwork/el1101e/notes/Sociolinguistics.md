...
> [!example] All the speakers of English in the world
...
> [!definition] Mutual intelligibility
> Linguistic criteria for determining which two speech varieties are considered by the same language
> 
> > [!question] Can speaker of speech variety A understand speaker of speech variety B, and vice-versa?

If two varieties are 
- linguistically distinct
- not mutually intelligible
they are classified as separate languages (instead of dialects of the same language).

> [!note] Sharing same writing system is irrelevant
> Language exists without writing - the focus is on phonological, lexical, syntactical differences.

> [!example] Mandarin, Cantonese, Hokkien...
...
> [!note] Dialects exhibit their own phonological, lexical and morphosyntactic peculiarities, but these differences are not great enough to prevent mutual intelligibility.

> [!definition] Dialect continuum
...
> [!note] Social meaning of linguistic variety is determined mostly by social status of the people who use it

> [!note] Language attitudes
> Judgment about people are made based on their speech
> 
> > [!example] Linguistic profiling
> 
...
> [!definition] Communicative competence
...
> [!definition] Language maintenance
...
> [!example] The superstrate for Jamaican creole is English, with substrates such as Akan (West African Language).

> [!definition] Decreolization
> Retreat from the use of the creole by those who have greater ocntact with a standard variety of the language.

> [!note] Post-Creole Continuum
